defmodule Timber.Plug.HTTPContextTest do
  use ExUnit.Case

  alias Timber.Plug.HTTPContext
  ...
  describe "Timber.Plug.HTTPContext.call/2" do
    test "captures HTTP method" do
      conn = Plug.Test.conn(:delete, "/")

      HTTPContext.call(conn, [])
    ...
    test "captures request ID from custom header", %{conn: conn} do
      ...
      HTTPContext.call(new_conn, request_id_header: request_id_header)
